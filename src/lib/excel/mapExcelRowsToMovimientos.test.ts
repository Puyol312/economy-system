...
test("mapea una fila con crédito correctamente", (t) => {
  const rows: RowExcel[] = [{ Fecha: "04/01/2026", Asunto: "Sueldo", Crédito: 50000 }];
...
test("convierte fecha del último día del mes correctamente", (t) => {
  const rows: RowExcel[] = [{ Fecha: "03/31/2026", Asunto: "Pago", Débito: 1000 }];
...
test("convierte fecha del primer día del mes correctamente", (t) => {
  const rows: RowExcel[] = [{ Fecha: "03/01/2026", Asunto: "Sueldo", Crédito: 50000 }];
...
test("convierte correctamente diciembre", (t) => {
  const rows: RowExcel[] = [{ Fecha: "12/31/2026", Asunto: "Cierre", Crédito: 1000 }];
...
test("ignora filas sin crédito ni débito", (t) => {
  const rows: RowExcel[] = [{ Fecha: "04/01/2026", Asunto: "Sin monto" }];
...
test("el tipo del resultado es 'debito' como literal", (t) => {
  const rows: RowExcel[] = [{ Fecha: "04/01/2026", Asunto: "Alquiler", Débito: 20000 }];
...
test("ignora filas con fecha en formato incorrecto", (t) => {
  const rows: RowExcel[] = [{ Fecha: "2026-04-01", Asunto: "Sueldo", Crédito: 50000 }];
...
test("ignora filas con fecha vacía", (t) => {
  const rows: RowExcel[] = [{ Fecha: "", Asunto: "Sueldo", Crédito: 50000 }];
...
test("ignora filas con Asunto vacío", (t) => {
  const rows: RowExcel[] = [{ Fecha: "04/01/2026", Asunto: "", Crédito: 50000 }];
