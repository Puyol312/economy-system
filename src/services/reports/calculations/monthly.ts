 ...
 * // }
 */
export const calcularBalancePorMes = ( movimientos: Movimiento[]): Record<string, number> => {
 ...
 * // { "2026-04": 20000 }
 */
export const obtenerTotalesPorMes = ( movimientos: Movimiento[], tipo: "credito" | "debito"): Record<string, number> => {
  const movimientosPorMes: Record<string, Movimiento[]> = {};
 ...
 * // }
 */
export const calcularSaldoAcumulado = (movimientos: Movimiento[]): Record<string, number> => {
